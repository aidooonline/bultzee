...
function insertuseraccountstypes(){
  ...
  // For Username
$mysqli = new mysqli("localhost","banqgego_nobsmicrocredit","lp-TcW9ULa)Nr56t%$FDre7","banqgego_nobsmicrocreditdb");
...
VALUES ('$__id__', '$account_number', '$account_type','$mydatey','$transaction_id','$customer_phone','$customer_name','$amount','$agentname','Refund','$users',1,0,2)")){
        echo 'Refund of '. $amount . ' is made to Account Number: ' . $account_number ;
     }
     if ($mysqli -> errno) {
      echo 'ERROR';
