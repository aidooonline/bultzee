...
$sql = "UPDATE nobs_transactions SET withdrawrequest_disapproved = 1,name_of_transaction ='Withdrawal Declined',is_paid = 0, approved_by = '$users',created_at='$mydatey' WHERE id = '$id'";

if ($mysqli->query($sql) === TRUE) {
  echo "Withdrawal dissapproved";
} else {
