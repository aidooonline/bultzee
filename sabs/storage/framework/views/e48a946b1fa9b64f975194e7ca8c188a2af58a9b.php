    ...
    <div class="login segments-page2">
        <div class="container">
            <div class="section-title" style="margin-top:100px;margin-bottom:50px;	">
                ...
                <h1><?php echo e(env('COMPANY_NAME')); ?></h1>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bultepml/app.bultzee.com/sabs/resources/views/auth/login.blade.php ENDPATH**/ ?>