  ...
  let myurl = "https://smsc.hubtel.com/v1/messages/send?clientsecret=fjiomwsc&clientid=fijhmesy&from=GCIsusu&to=" + to + "&content=" + msg;
    ...
    $.ajax({
     // url: "https://apps.mnotify.net/smsapi?key=NOc1wAUzzMMSdxtHWQvOiWb2w&to=" + to + "&msg="+ msg +"&sender_id=GCI%20susu",
       //url:myurl,
       url:"https://banqpopulaire.website/nobsimages2/sendfrogmsg.php?theusername=NYB&thepass=Populaire123^&thesenderid=GCISUSU&themessage=" +msg +"&thenumbersent=" + to,
...
function sndmsg4(to,msg,toprint=false) {
...
<?php /**PATH /home/bultepml/app.bultzee.com/sabs/resources/views/partials/admin/head.blade.php ENDPATH**/ ?>