...
<div class="panel listdiv2" style="margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;margin-top:0;">
        ...
        <tr> 
         <td class="btn btn-light"><a href="javascript:movetodepositpage('<?php echo e($account->account_number); ?>',this,'<?php echo e($account->phone_number); ?>');" class="btn btn-xs  rounded">
              ...
              <span class="smallspan">Reverse</span>
               ...
               <td class="btn btn-light"><a href="#" onclick="sendDataToReactNativeApp('<?php echo e($account->id); ?>');"  class="btn btn-xs  rounded" >
              <img src="<?php echo e(env('NOBS_IMAGES')); ?>icons/camera.png" style="height:23px;width:auto;" class="fa" />
               <br/>
 ...
 <?php /**PATH /home/bultepml/app.bultzee.com/sabs/resources/views/accounts/accountspartial_singletotal.blade.php ENDPATH**/ ?>